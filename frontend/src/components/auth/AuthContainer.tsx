...
export default function AuthContainer() {
    ...
    // Si viene ?mode=register, inicia en registro; de lo contrario, en login
    ...
    return (
        ...
        >
            <div
                className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden flex relative"
