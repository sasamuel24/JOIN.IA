...
@router.get("/feedback/community-stats", response_model=CommunityStatsResponse)
def get_community_stats(db: Session = Depends(get_db)) -> CommunityStatsResponse:
    """Public endpoint — aggregated pain points, total count and testimonials."""
    return feedback_service.get_community_stats(db)
